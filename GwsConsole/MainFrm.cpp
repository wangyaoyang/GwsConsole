	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateStatic(this, 1, 2))
		return FALSE;
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CGwsConsoleView), CSize(800, 400), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CGwsWebServerView), CSize(100, 400), pContext)) {
